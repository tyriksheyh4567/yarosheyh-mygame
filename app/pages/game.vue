  ...
  <div class="container mx-auto p-4">
    ...
    <div class="grid grid-cols-1 gap-4">
      ...
      <div class="grid grid-cols-5 gap-2">
        <div v-for="(category, index) in categories" :key="index" class="bg-blue-800 text-white p-4 text-center font-bold rounded">
          {{ category.name }}
        </div>
      </div>
      
      <!-- Questions -->
      <div v-for="points in [100, 200, 300, 400, 500]" :key="points" class="grid grid-cols-5 gap-2">
        <UButton
        ...
        <template #footer>
          <div class="flex flex-col gap-4">
            ...
            <div class="flex justify-between">
              <div>
                <span class="font-bold">Текущий игрок:</span> {{ players[currentPlayerIndex].name }}
              </div>
...
const categories = ref([
  ...
  { 
    ...
    questions: {
      ...
      400: { question: 'Сколько океанов на Земле?', answer: '5' },
      500: { question: 'Какая страна имеет наибольшее количество границ?', answer: 'Китай и Россия (по 14)' }
    }
  },
  { 
    name: 'Литература',
    questions: {
      ...
      500: { question: 'Какое произведение начинается со слов "В начале было Слово"?', answer: 'Евангелие от Иоанна' }
    }
  },
  { 
    name: 'Кино',
    questions: {
      ...
      200: { question: 'Какой фильм получил больше всего Оскаров?', answer: '"Титаник", "Бен-Гур" и "Властелин колец" (по 11)' },
